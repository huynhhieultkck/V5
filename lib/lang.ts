...
/**
 * Định nghĩa cấu trúc bắt buộc cho mọi ngôn ngữ để tránh lỗi "unknown property"
 */
...
const messages: Record<Language, ITranslations> = {
  VI: {
    ...
    storage_error: "Không thể lấy dữ liệu từ kho lưu trữ (OneDrive).",
  ...
  RU: {
    ...
    auth_banned: "Ваш аккаунт заблокирован.",
    ...
    order_forbidden: "Доступ запрещен.",
    order_not_ready: "Заказ не готов.",
    order_fetch_success: "Список заказов получен.",
    storage_error: "Ошибка хранилища.",
    stock_import_success: "Импорт успешен.",
    stock_empty: "Пусто.",
    stock_invalid_type: "Тип не поддерживается.",
    stock_deleted: "Удалено.",
    stock_cleared: "Очищено.",
    coupon_invalid: "Купон недействителен.",
    coupon_usage_limit: "Лимит исчерпан.",
    coupon_min_order: "Мин. сумма не достигнута.",
    ...
    mail_reset_text1: "Нажмите кнопку для сброса:",
    mail_reset_button: "Сброс",
    mail_reset_footer: "Проигнорируйте, если не вы.",
  },
  ZH: {
    system_error: "系统错误。",
    ...
    category_fetch_error: "获取分类出错。",
    category_not_found: "找不到该分类。",
    category_deleted: "删除成功。",
    ...
    transaction_fetch_success: "交易记录获取成功。",
